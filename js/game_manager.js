...
GameManager.prototype.addRandomTile = function (grid) {
  var grid = typeof grid === 'undefined'? this.grid : grid;
...
// Simulate a move on the grid
GameManager.prototype.simulate = function(grid, direction) {
  // 0: up, 1: right, 2: down, 3: left
  var self = this;
...
GameManager.prototype.run = function() {
  var best = this.ai.getBest();
  this.move(best.move);
  var timeout = globals.animationDelay;
